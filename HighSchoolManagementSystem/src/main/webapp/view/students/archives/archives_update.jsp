...
<body>
	...
	<form action="${ pageContext.request.contextPath }/students/archives/update.action" 
		...
		<div class="row">
			...
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<c:if test="${ studentsbaseInfo.photo!=null }">
							<img alt="" src="/HighSchoolManagementSystem/src/main/webapp/WEB-INF/studentAcademicPhoto/${studentsbaseInfo.photo}" width="100" height="100">
						</c:if>
