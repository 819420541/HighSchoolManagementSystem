				...
				<ul class="nav nav-list">
			    	...
			    	<li>
						...
						<ul class="submenu">
							...
							<li><a href="${pageContext.request.contextPath }/database/semesters/list.action" 
									target="mainframe">
								<i class="icon-double-angle-right"></i> 学期管理 
							</a></li>
							
							<li><a href="${pageContext.request.contextPath}/database/coursebooks/list.action" 
									target="mainframe">
								<i class="icon-double-angle-right"></i> 教材管理 
							</a></li>
							...
							<li><a href="${pageContext.request.contextPath}/database/courses/list.action"
									target="mainframe">
								<i class="icon-double-angle-right"></i> 课程管理
							</a></li>
						</ul>
					</li>
					...
					<li>
						<a href="javascript:void(0)" target="mainframe" class="dropdown-toggle">
							<i class="icon-desktop"></i>
							<span class="menu-text"> 班级数据 </span> 
							<b class="arrow icon-angle-down"></b>
						</a>
						...
						<ul class="submenu">	
                            <li><a href="${pageContext.request.contextPath }/classes/classes/list.action" 
                            		target="mainframe"> 
                            	<i class="icon-double-angle-right"></i> 班级管理
							</a></li>
							<li><a href="${pageContext.request.contextPath}/classes/academic/list.action" 
                            		target="mainframe"> 
                            	<i class="icon-double-angle-right"></i> 学术活动
							</a></li>
						</ul>
					</li>
					...
					<li>
						...
						<ul class="submenu">
                            <li><a href="${pageContext.request.contextPath}/students/archives/list.action" 
                            		target="mainframe"> 
                            	<i class="icon-double-angle-right"></i> 学生档案
							</a></li>
                            <li><a href="${pageContext.request.contextPath}/students/attendance/list.action" 
                            		target="mainframe"> 
                            	<i class="icon-double-angle-right"></i> 出勤管理
							</a></li>
						</ul>
					</li>
					...
					<li>
						<a href="javascript:void(0)" target="mainframe" class="dropdown-toggle">
							<i class="icon-desktop"></i> 
							<span class="menu-text"> 统计图表 </span> 
							<b class="arrow icon-angle-down"></b>
						</a>
						
						<ul class="submenu">
							<li><a href="${pageContext.request.contextPath}/graph/achievements/list.action" 
									target="mainframe">
								<i class="icon-double-angle-right"></i> 考试成绩
							</a></li>
							<li><a href="${pageContext.request.contextPath}/graph/qualifiedstudent/list.action" 
									target="mainframe">
								<i class="icon-double-angle-right"></i> 合格人数
							</a></li>
							<li><a href="${pageContext.request.contextPath}/graph/attendance/list.action"
									target="mainframe">
								<i class="icon-double-angle-right"></i> 班级考勤
							</a></li>
						</ul>
					</li>
				</ul>
