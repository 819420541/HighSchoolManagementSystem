...
@Controller
@RequestMapping("/graph/qualifiedstudent")
public class QualifiedstudentController {

	@Resource(name = "achievementsServiceImpl")
	private AchievementsService achievementsService;
	
	@RequestMapping("list.action")
	public String qualifiedstudentGraph(){  
		return "/graph/qualifiedstudent/qualifiedstudent_graph";  
	}
	...
	public ModelAndView getColumnChart(Studentstudyrecord studentstudyrecord, Model model, HttpServletRequest request, ModelMap modelMap) 
		...
		return new ModelAndView("graph/qualifiedstudent/qualifiedstudent_graph", modelMap);
